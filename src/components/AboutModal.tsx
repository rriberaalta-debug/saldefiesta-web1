  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        <div className="text-left max-w-none space-y-4 text-gray-300">
            ...
            <h3 className="text-xl font-bold text-white pt-2 border-t border-white/10">Las Funcionalidades Clave (La Utilidad para el Usuario)</h3>
            <p>
            ...
            <h3 className="text-xl font-bold text-white pt-2 border-t border-white/10">La Conclusión (El Llamamiento a la Acción)</h3>
            <p>
